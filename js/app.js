...
w2v.loadModel( './data/glove.6B.50d.txt', function(err, model){
	...
	console.log("analyzing word vectors...");
	...
	_.forEach(taggedText, function(set) {		
		...
		_.forEachRight(similarityArray, function(obj) {
			...
			//make a new array of word/tag arrays consisting of similar words to original
			//not strictly necessary at this point
			similarSet.push(obj.word, similarTag);
			similarWordList.push(similarSet);
		});
